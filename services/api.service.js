...
const ApiService = {
    ...
    validate_set_set(target_id, target, ref_id, ref, runs, replace, enriched,distance, background, type){
        let data = {target:target, target_id:target_id, reference:ref, reference_id:ref_id, runs: runs, replace: replace, enriched: enriched, distance:distance, background_model:background, type: type}
        console.log(data)
