<template>
  <div>
    <div style="background-color: cornflowerblue; width: 100%; padding:16px">
      <h2 :style="{display: 'flex', 'justify-content': 'center', color: 'white', 'font-size': mobile ? '2.5rem' : '4rem'}">Documentation</h2>
    </div>
        ...
        <div style="text-align: justify; margin-bottom: 48px">
          <ul>
            ...
            <ul>
              ...
              Supported type: graphml and sif</li>
              ...
              which has the ID names saved is needed.</li>
            </ul>
            ...
            <li><b>Background model</b>
              <ul>
                ...
                <li><b>Network based:</b> New random subnetworks are determined, while preserving information from
                  ...
                  connected components are selected.</li>
              </ul>
            </li>
          ...
          <ul><br>
            ...
            <li><b>Significance contribution figures:</b>
              <ul>
                ...
                calculated contributions of each gene separately for each respective annotation type.</li>
