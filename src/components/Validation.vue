    ...
    <div
      ...
      <template v-if="step===0">
        <div style="display: flex; justify-content: center; width: 100%">
          <!--          <div>-->
          <!--            DIGEST allows the user to in silico validate a set or clustering of genes as well as diseases and compute an empirical P-value.<br><br>-->
          ...
          <!--          </div>-->
          <!--/*          <div style="justify-content: center; margin-left: auto; margin-right: auto; width: 100%">*/-->
      ...
      <template v-if="step===1">
        <template v-if="params.mode==='cluster'">
          <!--          <ul>-->
          <!--            <h4>Clusterings can be validated reference-free based on three different clustering quality measures. </h4>-->
          <!--            <br>-->
          <!--            <li><b>Dunn Index</b>: calculates the ratio of the cluster with the lowest density compared to the two-->
          <!--              clusters that are closest to each other.-->
          <!--            </li>-->
          <!--            <li><b>Silhouette Score</b>: Calculates the average of the ratio of each element's distance to another-->
          <!--              cluster and its own density to the maximum of the two values.-->
          <!--            </li>-->
          <!--            <li><b>Davies Bouldin Index</b>: calculates for all clusters in pairs how strong the density of the elements-->
          <!--              in their own cluster is compared to the distance between the two clusters.-->
          <!--            </li>-->
          <!--          </ul>-->
        </template>
        <template v-else>
          ...
          <!--            <li><b>set reference-free</b>: Assesses whether the internal functional or genetic coherence of the genes-->
          <!--              contained is statistically significant.-->
          <!--            </li>-->
          <!--            <li><b>set against set</b>: Assesses whether the functional or genetic similarity of each element in the-->
          <!--              target set separately is statistically significant to the reference.-->
          <!--              For this purpose, all annotations or only the enriched ones of the reference can be used.-->
          <!--            </li>-->
          <!--            <li><b>set against id</b>: If both the set and the id are both diseases or genes, the assessment is equal to-->
          <!--              the set-set.<br>Comparing a gene set against a disease id it-->
          <!--              assesses whether the functional relevance is statistically significant-->
          <!--            </li>-->
          <!--          </ul>-->
      ...
      <template v-if="step===2">
        ...
        <!--          <li><b>Under Input</b>: shows the input as well as the selected parameters and additionally gives the sole-->
        <!--            functional or genetic score(s) for the input.-->
        <!--          </li>-->
        <!--          <li><b>Under Result</b>: shows the statistical significance of the input score with respect to a background-->
        <!--            model using empirical P-values.<br>-->
        <!--            Additionally provides a visual representation of the results. <i>The complete results can be downloaded-->
        <!--              directly.</i></li>-->
        <!--        </ul>-->
      </template>
    </div>
