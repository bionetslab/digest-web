              ...
              <v-tooltip right>
                ...
                <div style="width: 400px;">
                  <div style="display: flex">
                    ...
                    <div style="width: 60%; text-align: justify">
                      Model draws {{ type }} uniformly without replacement to compute fully randomized {{ type }}
                      sets
                      of
                      target set
                      size.
                  ...
                  <div style="display: flex; margin-top: 8px;">
                    ...
                    <div style="width: 60%; text-align: justify">
                      Model maintains some information from target set and constructs randomized {{ type }} sets
                      where
                      the
